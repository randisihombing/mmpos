  ...
  <div class="box">
    <div class="box-header">
      ...
      <div class="pull-right">
        <a href="<?= site_url('stock/out/tambah'); ?>" class="btn btn-primary btn-flat">
          <i class="fa fa-user-plus"> Tambah Stock Out</i>
        </a>
      </div>
    </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center" width="160px">
              ...
              <!-- <a href="<?= site_url('stock/out/hapus/'.$data->stock_id.'/'.$data->item_id); ?>" onclick="return confirm('Apakah Data Ini Ingin Dihapus ?')" class="btn btn-danger btn-xs ">
