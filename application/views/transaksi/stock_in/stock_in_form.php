          ...
          <tbody>
            <?php foreach ($item as $i => $data) { ?>
              <tr>
                ...
                <td><?= $data->stock ?></td>
                <td>
                  <button class="btn btn-xs btn-info" id="pilih" data-id="<?= $data->item_id ?>" data-barcode="<?= $data->barcode ?>" data-name="<?= $data->name ?>" data-unit="<?= $data->unit_name ?>" data-stock="<?= $data->stock ?>">
